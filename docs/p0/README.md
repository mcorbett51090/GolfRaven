...
| K1 | Operator + sponsor signal | Matt (outreach/relationship calls) | DEFERRED — decision 0004: the full product is built before any outreach; K1's windows re-anchor to the outreach start date Matt logs in `docs/p0/K1.md`. 9 unsent drafts stay in Matt's Gmail; contacts in `docs/partners/k1-outreach.md`. K1 no longer gates P1 | _(blank)_ |
