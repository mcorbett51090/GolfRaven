...
- **Uses, and amends once accepted:** the plan's own staging rule, FM-08 (plan §10 conventions): *"Where only part of a phase depends on
  a gate, the phase is split into numbered stages, each with its own gate."* P1.0 is such a stage. Once accepted,
