...
SELECT is(
  (SELECT player_handle_snapshot FROM app.attestation_shift_log WHERE facility_id = 'fac_x' AND kind = 'presence' AND player_pseudonym = encode(public.hmac('00000000-0000-0000-0000-00000000000a', current_setting('app.pseudonym_key'), 'sha256'), 'hex')),
  'deleted player',
